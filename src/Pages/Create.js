                ...
                <CCardBody className="p-4">
                  <CForm onSubmit={handleSubmit()}>
                    ...
                    <div className="mb-4">
                      ...
                      <CFormText id="interest">
                        Pilih hal yang Anda minati
                      </CFormText>
                      <CInputGroup aria-describedby="interest">
                        ...
                        >
                          ...
                          <option value="Edukasi">
                            Edukasi (Pengajar, Studi di Perguruan Tinggi)
                          </option>
                          <option value="Telekomunikasi">
                            Telekomunikasi (Progammer Komputer, Analist Sistem
                            Komputer, Arsitek Database, Administrator Sistem
                            Jaringan dan Komputer)
                          </option>
                          <option value="IT">
                            Informatika (Web Developer, Software Engineer, Game
                            Developer)
                          </option>
                          <option value="Komunikasi">
                            Komunikasi (Administrator, Customer Service,
                            Marketing, Jurnalis, Influencer)
                          </option>
                          <option value="Wirausaha">
                            Wirausaha (Food and Beverage, Produsen Kreatif,
                            Distributor, Dropshipper)
                          </option>
                          <option value="Olahraga">
                            Olahraga (Atlet, Pembina, Pelatih)
                          </option>
                          <option value="Seni">
                            Seni (Musik, Fotografi, Modelling, Desain Grafis)
                          </option>
                        </CFormSelect>
                      </CInputGroup>
                    </div>
